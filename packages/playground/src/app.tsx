...
import { Theme as MisticaTheme, Vivo_New, Vivo, O2, O2_New, Movistar, Telefonica, Blau, Tu } from '@rjsf/mistica';
...
const themes: PlaygroundProps['themes'] = {
  ...
  mistica: {
    stylesheet: '//cdn.jsdelivr.net/npm/@telefonica/mistica@15.17.0/css/mistica.min.css',
    theme: MisticaTheme,
    skins: {
      Vivo_New,
      Vivo,
